...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 4
    actual = count_negatives((-15, -20, -30, 14, 13, 7, -5))
    print()
    ...
    # Test 7:
    expected = 4
    actual = count_negatives((1, 2, 3, 4, 5, -1, -2, -3, -4))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 0
    seq = [[23, 34, 232, 234, 3, 234], [1, 1, 1, 43, 34, 345]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 1
    seq = [[1, 1, 1, 5, 5, 5, 5], [1, 1], [1, 1, 1, 3, 4, 5], [1, 1, 1]]
    actual = count_short_ones(seq)
    print()
